...
def mobilenet(type_quant= None, activ_bits =None, weight_bits= None, activ_type='hardtanh',  width_mult=1.0, input_dim = 224,**kwargs):
    ...
    if type_quant == 'PerLayerAsymMinMax' or type_quant == 'PerLayerAsymPACT' or type_quant == 'PerChannelsAsymMinMax':
      model = mobilenet_quant_devel(width_mult, input_dim, activ_bits, weight_bits, activ_type)
